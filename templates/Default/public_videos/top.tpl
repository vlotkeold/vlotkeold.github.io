...
<input type="text" value="Поиск видеозаписей по названию" class="fave_input" style="width:500px; id="query_video" 
...
maxlength="80" />
<div class="button_div fl_r" style="margin-top:5px;"><button onClick="PublicVideoSearch(); return false" id="se_but_load">Найти</button></div>
<div class="clear"></div>
</div>
<div class="clear"></div>
<div id="seResult">
