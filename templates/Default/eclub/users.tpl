...
<div class="sft" style="margin-top:-6px">
 ...
 <a href="/eclub?act=edit&cid={pid}" onClick="Page.Go(this.href); return false;"><div>Информация</div></a>
 <div class="buttonsprofileSec2"><a href="/eclub?act=users&cid={pid}" onClick="Page.Go(this.href); return false;"><div>Участники</div></a></div>
...
<div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="height:32px;margin-bottom: -10px;">
  <div class="{button_tab_a}"><a href="/eclub?act=users&cid={pid}" onclick="Page.Go(this.href); return false;"><div><b>Все участники</b></div></a></div>
  [yesfev]<div class="{button_tab_r}"><a href="/eclub?act=faveuser&cid={pid}" onclick="Page.Go(this.href); return false;"><div><b>Заявки</b></div></a></div>[/yesfev]
  <div class="{button_tab_b}"><a href="/eclub?act=users&cid={pid}&tab=admin" onclick="Page.Go(this.href); return false;"><div><b>Руководители</b></div></a></div>
</div>
</div>
