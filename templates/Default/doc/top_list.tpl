...
<div style="padding:5px 0px;"><input type="text" style="width:430px;color:black" id="docsearch" placeholder="Поиск по документам" onkeydown="doc.search(1,1);" class="friends_se_search friends_s_search" value="">
...
<div class="summary">У Вас <span id="upDocNum">{doc-num}</span> <span id="langNumric"></span></div>
</div>
