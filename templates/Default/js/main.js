...
var NewsLast = {
	MoreMenu: function(){
		$('#moreMenu').show();
		$('#moreMenuText').text('Скрыть');
		$('#moreMenuLnk').attr('onClick', 'NewsLast.HideMenu()');
	},
	HideMenu: function(){
		$('#moreMenu').hide();
		$('#moreMenuText').text('Свежие новости');
...
var menuadmin = {
	MoreMenu: function(){
		$('#moreMenu1').show();
		$('#moreMenuText1').text('Скрыть подсказки');
		$('#moreMenuLnk1').attr('onClick', 'menuadmin.HideMenu()');
	},
	HideMenu: function(){
		$('#moreMenu1').hide();
		$('#moreMenuText1').text('Как сделать страницу эффективнее?');
...
lang_infosaveclub				= '<b>Изменения сохранены.</b><br><br>Основная информация и настройки группы сохранены.';
...
lang_subscription2				= 'Вы отменили свою заявку и отписались.';
...
lang_se_go						= 'Найти';
lang_bad_format					= 'Загружать разрешено только фотографии в формате JPG, PNG.';
...
lang_stikers_tnoubm				= 'У Вас недостаточно голосов для отправки этого стикера.';
lang_stikers_oktitle			= 'Стикер отправлен';
lang_stikers_oktext				= 'Ваш стикер был успешно отправлен.';
...
lang_wall_atttach_addstiker		= 'Выберите стикер для отправки';
