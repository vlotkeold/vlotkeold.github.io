...
<div class="miniature_box">
 <div class="miniature_pos" style="width:500px">
  <div class="payment_title">
   ...
   <div class="fl_l">
   Пополнение счета отправкой SMS сообщения.<br />
    Ваш текущий баланс: <b>{ubm} голос</b>
   </div>
   <div class="fl_r">
...
<a href="/" onClick="viiBox.clos('mt_sms', 1); payment.metodbox(); return false;" style="width:188px"><div>Выбрать другой способ оплаты</div></a>
</div>
  <div class="no_display" id="smsblock">
  <div class="payment_block">
   Для получения <b>рублей</b> на Ваш счёт, отправьте платное SMS сообщение c текстом <b><span id="smspref"></span>424qhscgk{user-id}</b> на номер <b id="smsnumber">9797</b><br /><br />
