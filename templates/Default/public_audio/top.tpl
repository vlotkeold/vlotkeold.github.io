...
<input type="text" value="Поиск по композициям и исполнителям" class="fave_input" style="width:500px; id="query_audio" 
...
maxlength="80" />
<div class="button_div fl_r" style="margin-top:5px;"><button onClick="PublicAudioSearch(); return false" id="se_but_load">Найти</button></div>
<div class="clear"></div>
</div>
<div class="clear"></div>
<div id="seResult">
