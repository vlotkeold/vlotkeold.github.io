...
<div class="allbar_title forum_view_title" style="padding: 10px 5px 5px 12px;">В теме <span id="msgNumJS">{msg-num}</span> <span id="langMsg">сообщение</span></div>
...
<textarea 
	...
	placeholder="Комментировать.. Enter - перевод строки."
	onKeyPress="if(event.keyCode == 10 || (event.ctrlKey && event.keyCode == 13)) Forum.SendMsg('{fid}')"
></textarea>
<div class="clear"></div>
<div class="button_div fl_l" style="margin-left:64px"><button onClick="Forum.SendMsg('{fid}'); return false" id="msg_send">Отправить Ctrl+Enter</button></div>
