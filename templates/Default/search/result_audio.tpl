<div class="audio_onetrack" style="border-bottom:0px;border-top:1px dashed #dde5ed;margin-left:0px">
 <div class="audio_playic cursor_pointer fl_l" onClick="music.newStartPlay('{jid}')" id="icPlay_{jid}"></div>
  <span id="music_{jid}" data="{url}">
   <a href="/?go=search&query={artist}&type=5&n=1" onClick="Page.Go(this.href); return false"><b><span id="artis{aid}">{artist}</span></b></a> &ndash; <span id="name{aid}">{name}</span> <a href="/id{author-id}" onClick="Page.Go(this.href); return false"><small>({author-n}. {author-f})</small></a>
  </span>
