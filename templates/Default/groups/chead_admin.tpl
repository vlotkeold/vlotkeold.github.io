...
<br /><br />
Вы можете <a href="/groups" onClick="groups.created(); return false">создать сообщество</a> или воспользоваться <a href="/?go=search&type=6" onClick="Page.Go(this.href); return false" id="se_link">поиском по сообществам</a>.<br /><br /><br />
</div>[/no]