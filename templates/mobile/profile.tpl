...
[blacklist][privacy-msg]<button class="button" onClick="messages.new_({user-id}); return false" style="width:49%">Написать сообщение</button>[/privacy-msg][/blacklist]
[no-friends][blacklist]<button class="button" onClick="friends.add({user-id}); return false" style="width:50%">Добавить в друзья</button>[/blacklist][/no-friends]
[yes-friends]<button class="button" onClick="friends.goDelte({user-id}); return false" style="width:49%">Убрать из друзей</button>[/yes-friends]
</div>
[/not-owner]
</div>
