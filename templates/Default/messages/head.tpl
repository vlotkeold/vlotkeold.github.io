...
<div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond2" style="height:10px">
 <div class="buttonsprofileSec2"><a href="/messages" onClick="Page.Go(this.href); return false;"><div>Полученные</div></a></div>
...
<div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond2" style="height:10px">
 ...
 <div class="buttonsprofileSec2"><a href="/messages/outbox" onClick="Page.Go(this.href); return false;"><div>Отправленные</div></a></div>
</div>
<div class="clear"></div><div style="margin-top:-1px;"></div>
<div class="msg_se_bg"><input type="text" value="{query}" class="fave_input msg_se_inp fl_l" onblur="if(this.value==''){this.value='Поиск по отправленным сообщениям';this.style.color = '#c1cad0';}" onfocus="if(this.value=='Поиск по отправленным сообщениям'){this.value='';this.style.color = '#000'}" id="msg_query" maxlength="130" onKeyPress="if(event.keyCode == 13)messages.search(1);" style="width:500px"/>
<div class="button_blue fl_l msg_pad_top"><button onClick="messages.search(1); return false">Найти</button></div>
<div class="clear"></div>
</div>
...
[review]<div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond2" style="height:10px;">
 <a href="/messages" onClick="Page.Go(this.href); return false;">Полученные</a>
 <a href="/messages/outbox" onClick="Page.Go(this.href); return false;">Отправленные</a>
 <div class="buttonsprofileSec2"><a href="/" onClick="Page.Go('/messages/show/{mid}'); return false"><div>Просмотр сообщения</div></a></div>
</div>
